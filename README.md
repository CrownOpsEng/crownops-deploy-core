...
- on a first run, `scripts/configure.sh` can generate a bootstrap Ed25519 SSH key under the local wizard state directory, pause, show the exact `ssh-copy-id` and test commands to run, and then resume from a saved answers file
